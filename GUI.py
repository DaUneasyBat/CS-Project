...
class AudioGUI:
    ...
    def setup_gui(self):
        ...
        waveform_button = tk.Button(self.root, text="Display Waveform", command=self.plot_waveform)
    ...
    def display_resonance(self):
        ...
        messagebox.showinfo("Resonance Frequency", f"Highest Resonance Frequency: {resonance_frequency} Hz")
